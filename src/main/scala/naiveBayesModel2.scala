...
object naiveBayesModel {
  def main(args: Array[String]) {
    ...
    val rawData = sc.textFile("file:///home/chc631/sparkClass/project/tweetwise_data/tweets_with_sentiment.txt")
    ...
    val labeledRDD = tweetsDF2.select("score", "tweet").rdd.map {
      ...
      val tweetInWords: Seq[String] = tweetTool.getBarebonesTweetText(tweet, stopWordsList)
    ...
    val test = tweetTool.getBarebonesTweetText("bitcoin is so good i should buy but i am shit at buying", stopWordsList)
