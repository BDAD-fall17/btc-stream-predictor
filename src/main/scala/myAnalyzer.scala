...
object PropertiesLoader {
  ...
  // val nltkStopWords = "home/chc631/sparkClass/project/btc-stream-predictor/NLTK_English_Stopwords_Corpus.txt"
}
/*
...
// val stopWordsList = sc.broadcast(StopwordsLoader.stopWords.collect.toList)
